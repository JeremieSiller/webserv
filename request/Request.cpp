...
void Request::addBody(std::vector<char>::const_iterator pos, std::vector<char>::const_iterator start, std::vector<char>::const_iterator end)
{
	this->_body.insert(pos, start, end);
}
